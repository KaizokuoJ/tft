...
const champions = {
  Aatrox: {
    ...
    items: ["titanichydra", "phantomdancer", "dragonsclaw"]
  },
  Ahri: {
    key: "Ahri",
    name: "Ahri",
    ...
    items: ["spearofshojin", "guinsoosrageblade", "rabadonsdeathcap"]
  },
  Akali: {
    key: "Akali",
    name: "Akali",
    ...
    items: ["spearofshojin", "hextechgunblade", "infinityedge"]
  },
  Anivia: {
    key: "Anivia",
    name: "Anivia",
    ...
    items: ["spearofshojin", "morellonomicon", "rabadonsdeathcap"]
  },
  Ashe: {
    key: "Ashe",
    name: "Ashe",
    ...
    ability: {
      ...
      description:
        "Ashe fires an arrow that travels across the map, damages, and stuns (stun duration based on each hex traveled).",
      type: "Active",
      manaCost: 100,
      manaStart: 0,
      stats: [
    ...
    items: ["spearofshojin", "guinsoosrageblade", "runaanshurricane"]
  },
  AurelionSol: {
    key: "AurelionSol",
    name: "Aurelion Sol",
  ...
  Braum: {
    ...
    items: ["thornmail", "zekesherald", "dragonsclaw"]
  },
  Chogath: {
    key: "Chogath",
    name: "Cho'Gath",
  ...
  Darius: {
    ...
    items: ["titanichydra", "warmogsarmor", "phantomdancer"]
  },
  Draven: {
    key: "Draven",
    name: "Draven",
    ...
    items: ["infinityedge", "rapidfirecannon", "phantomdancer"]
  },
  Elise: {
    key: "Elise",
    name: "Elise",
    ...
    items: ["warmogsarmor", "guinsoosrageblade", "phantomdancer"]
  },
  Evelynn: {
    key: "Evelynn",
    name: "Evelynn",
    ...
    items: ["rabadonsdeathcap", "morellonomicon"]
  },
  Fiora: {
    key: "Fiora",
    name: "Fiora",
    ...
    items: ["frozenheart", "zekesherald", "phantomdancer"]
  },
  Gangplank: {
    key: "Gangplank",
    name: "Gangplank",
    ...
    items: ["titanichydra", "morellonomicon"]
  },
  Garen: {
    key: "Garen",
    name: "Garen",
    ...
    items: ["morellonomicon", "warmogsarmor", "phantomdancer"]
  },
  Gnar: {
    key: "Gnar",
    name: "Gnar",
    ...
    items: ["frozenheart", "warmogsarmor", "phantomdancer"]
  },
  Graves: {
    key: "Graves",
    name: "Graves",
    ...
    items: ["redbuff", "titanichydra", "warmogsarmor"]
  },
  Karthus: {
    key: "Karthus",
    name: "Karthus",
  ...
  Kassadin: {
    ...
    items: ["guinsoosrageblade", "phantomdancer", "dragonsclaw"]
  },
  Katarina: {
    key: "Katarina",
    name: "Katarina",
  ...
  Kayle: {
    ...
    items: ["spearofshojin", "guinsoosrageblade", "seraphsembrace"]
  },
  Kennen: {
    key: "Kennen",
    name: "Kennen",
  ...
  Khazix: {
    ...
    items: ["spearofshojin", "infinityedge", "phantomdancer"]
  },
  Kindred: {
    key: "Kindred",
    name: "Kindred",
    ...
    items: ["guinsoosrageblade", "infinityedge"]
  },
  Leona: {
    key: "Leona",
    name: "Leona",
  ...
  Lucian: {
    ...
    items: ["infinityedge", "spearofshojin", "rapidfirecannon"]
  },
  Lulu: {
    key: "Lulu",
    name: "Lulu",
    ...
    items: ["guinsoosrageblade", "rabadonsdeathcap", "spearofshojin"]
  },
  MissFortune: {
    key: "MissFortune",
    name: "Miss Fortune",
    ...
    items: ["guinsoosrageblade", "rabadonsdeathcap", "morellonomicon"]
  },
  Mordekaiser: {
    key: "Mordekaiser",
    name: "Mordekaiser",
    ...
    items: ["frozenheart", "phantomdancer", "dragonsclaw"]
  },
  Morgana: {
    key: "Morgana",
    name: "Morgana",
  ...
  Nidalee: {
    ...
    items: ["rapidfirecannon", "bloodthirster", "guinsoosrageblade"]
  },
  Poppy: {
    key: "Poppy",
    name: "Poppy",
    ...
    ability: {
      ...
      stats: [
        ...
        {
          type: "Knockback Duration",
          value: "1s"
        },
        {
          type: "Stun Duration",
          value: "1.5s / 2.5s / 3.5s"
        },
        {
          type: "Delay",
          value: "0.75s"
  ...
  Pyke: {
    ...
    items: ["spearofshojin", "rabadonsdeathcap", "guinsoosrageblade"]
  },
  RekSai: {
    key: "RekSai",
    name: "Rek'Sai",
  ...
  Rengar: {
    ...
    items: ["infinityedge", "guinsoosrageblade", "rapidfirecannon"]
  },
  Sejuani: {
    key: "Sejuani",
    name: "Sejuani",
  ...
  Shen: {
    ...
    items: ["thornmail", "phantomdancer", "dragonsclaw"]
  },
  Shyvana: {
    key: "Shyvana",
    name: "Shyvana",
    ...
    items: ["frozenheart", "phantomdancer", "warmogsarmor"]
  },
  Swain: {
    key: "Swain",
    name: "Swain",
    ...
    items: ["morellonomicon", "phantomdancer", "dragonsclaw"]
  },
  Tristana: {
    key: "Tristana",
    name: "Tristana",
    ...
    items: ["titanichydra", "runaanshurricane", "guinsoosrageblade"]
  },
  Varus: {
    key: "Varus",
    name: "Varus",
  ...
  Vayne: {
    ...
    items: ["rapidfirecannon", "runaanshurricane", "guinsoosrageblade"]
  },
  Veigar: {
    key: "Veigar",
    name: "Veigar",
  ...
  Yasuo: {
    ...
    ability: {
      name: "Steel Tempest",
      description:
        "Yasuo stabs forward dealing damage. On third cast, Yasuo launches a tornado dealing damage and knocking up enemies in a line.",
      type: "Active",
      manaCost: 25,
      manaStart: 0,
      stats: [
  ...
  Zed: {
    ...
    items: ["infinityedge", "bloodthirster", "rapidfirecannon"]
  }
};
